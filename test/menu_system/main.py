...
BG = pygame.image.load("assets/main_menu_bg3.png")
...
def main_menu():
    while True:
        ...
        OPTIONS_BUTTON = Button(image=pygame.image.load("assets/gear2.png"), pos=(SCREEN.get_width() - 70, SCREEN.get_height() - 70), 
