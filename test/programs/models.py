...
class Cube:
    ...
    def __init__(self,app):
        ...
        self.texture = self.get_texture(path='programs/textures/ryan_gosling.jpeg')
        self.on_init()
    ...
    def get_shader_program(self, shader_name):
        with open(f'programs/shaders/{shader_name}.vert') as file:
            vertex_shader = file.read()

        with open(f'programs/shaders/{shader_name}.frag') as file:
